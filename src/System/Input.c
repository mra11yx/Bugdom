...
SDL_Gamepad			*gSDLGamepad = NULL;
	...
	#define DEFAULT_FIREBALL_SCANCODE1	SDL_SCANCODE_LCTRL
	#define DEFAULT_FIREBALL_SCANCODE2	SDL_SCANCODE_RCTRL
#else
	...
	#define DEFAULT_FIREBALL_SCANCODE1	0
	#define DEFAULT_FIREBALL_SCANCODE2	0
#endif
...
[kKey_Fireball			] = { "Fireball",			DEFAULT_FIREBALL_SCANCODE1, DEFAULT_FIREBALL_SCANCODE2, 0,				SDL_GAMEPAD_BUTTON_INVALID, },
